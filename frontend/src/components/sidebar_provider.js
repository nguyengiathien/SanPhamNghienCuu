...
import { faHouse, faUser, faCog, faChalkboard, faLinesLeaning, faPhone, faClipboardQuestion, faBuildingColumns } from "@fortawesome/free-solid-svg-icons";
        ...
        <aside className="z-3 bg-gradient-to-b from-indigo-600 to-violet-800 w-[50px] h-screen shadow-[0_25px_20px_var(--tw-shadow-color,_rgba(0,_0,_0,.5))] fixed">
            ...
            <nav className="p-4 mt-[2rem] relative">
                <ul>
                    ...
                    <li className="group/icon mb-2 absolute top-68 left-5 flex flex-row items-center">
                        <FontAwesomeIcon icon={faBuildingColumns} className="mr-2 p-[8px] text-white z-1 bg-indigo-400 rounded-[50%] aspect-square w-[40px] hover:shadow-[0_2px_4px_rgba(1,1,1,0.2)] transition-shadow duration-300" />
                        <a href="#lessons" className="text-indigo-400 hover:text-gray-800 absolute left-3 z-0 py-1 pl-3 pr-2 rounded-r-full font-semibold bg-white shadow-[0_2px_4px_rgba(1,1,1,0.2)] opacity-0 transition delay-150 duration-300 ease-in-out group-hover/icon:translate-x-5 group-hover/icon:opacity-100 hover:block text-sm text-nowrap">Questions Bank</a>
                    </li>
                    <li className="group/icon mb-2 absolute top-85 left-5 flex flex-row items-center">
                        <FontAwesomeIcon icon={faPhone} className="mr-2 p-[8px] text-white z-1 bg-indigo-300 rounded-[50%] aspect-square w-[40px] hover:shadow-[0_2px_4px_rgba(1,1,1,0.2)] transition-shadow duration-300" />
            ...
            <div className="group/icon absolute bottom-24 left-[50%] translate-x-[-50%] flex flex-row items-center">
                ...
                <div className="flex flex-col gap-2 absolute left-15 bg-white shadow-[0_5px_10px_var(--tw-shadow-color,_rgba(0,_0,_0,.2))] p-2 opacity-0 transition delay-150 duration-300 ease-in-out group-hover/icon:opacity-100 hover:flex rounded-lg">
                    ...
                    <a href="/signup" className="text-white text-center shadow-[0_5px_10px_rgba(1,1,1,0.3)] transition-[colors, shadow] duration-300 hover:shadow-none hover:text-gray-800 z-0 font-semibold bg-indigo-500 rounded-sm py-1 px-2">Logout?</a>
                </div>
            </div>
